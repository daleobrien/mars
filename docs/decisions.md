...
## D37 · 2026-09-14 · Step 14's rate-distortion optimisation: the rate-estimation approximation chosen, and the measured BD-rate (-8.07% mean) falls short of the brief's 10% target
