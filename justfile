...
#     asserts a -5% floor calibrated to that measurement (D37, `docs/decisions.md`), not
...
gate-14:
    ...
    @echo "gate-14: PASS (scoped to kodim01/kodim02, calibrated -5% BD-rate floor -- brief's own 10% target not yet cleared, see docs/decisions.md D37 and docs/predictions.md's Step 14 outcome)"
